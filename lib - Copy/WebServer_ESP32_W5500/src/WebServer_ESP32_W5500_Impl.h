...
bool W5500_eth_connected = false;
...
void ESP32_W5500_event(WiFiEvent_t event)
{
  switch (event)
  {
    ...
    case ARDUINO_EVENT_ETH_START:
      ...
      W5500ETH.setHostname("ESP32_W5500");
      break;
    ...
    case ARDUINO_EVENT_ETH_GOT_IP:
      if (!W5500_eth_connected)
      {
        ET_LOG3(F("ETH MAC: "), W5500ETH.macAddress(), F(", IPv4: "), W5500ETH.localIP());

        if (W5500ETH.fullDuplex())
        {
        ...
        ET_LOG1(W5500ETH.linkSpeed(), F("Mbps"));

        W5500_eth_connected = true;
      }
