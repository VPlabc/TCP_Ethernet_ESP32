...
enum PANEL_SCAN_RATE {NORMAL_ONE_SIXTEEN, ONE_EIGHT_32, ONE_EIGHT_16, ONE_EIGHT_4};
...
#endif	
{
  ...
  protected:
	...
	PANEL_SCAN_RATE _panelScanRate = ONE_EIGHT_4;//ONE_EIGHT_32;//NORMAL_ONE_SIXTEEN;
